  ...
  */
  ...
  function createStyledComponent(target, options, rules) {
    ...
    Object.defineProperty(WrappedStyledComponent, 'defaultProps', {
      ...
      set: function set$$1(defaultProps) {
        this._defaultProps = _extends({}, this._defaultProps, defaultProps, this._defaultProps.style || defaultProps.style ? {
          style: _extends({}, this._defaultProps.style || EMPTY_OBJECT, defaultProps.style || EMPTY_OBJECT)
        } : EMPTY_OBJECT);
      }
    });
